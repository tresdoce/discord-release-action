...
const run = async () => {
    try {
        ...
        const res = await http_client_1.default.post('https://discord.com/api/webhooks/976295901737914378/3MDpf4sHU1cVZ5dal7qwnnqQeCIukj_RBXMvlC3EcZ3CO4iYz68-EsVDG4bkmpqXWGUP', {
            data: {
                username: 'TresDoce',
